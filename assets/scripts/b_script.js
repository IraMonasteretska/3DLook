...
window.Swiper = __webpack_require__(/*! ./swiper.js */ "./src/js/swiper.js");
$(function () {
  $('select').selectric();
});

if (document.querySelector('.about__years')) {
  var swiper = new Swiper('.about__years', {
    slidesPerView: 'auto',
    spaceBetween: 10,
    centeredSlides: true,
    navigation: {
      nextEl: '.about__year_next',
      prevEl: '.about__year_prev'
    }
  });
} // Custom input file
